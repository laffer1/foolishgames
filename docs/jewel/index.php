...
<head>
    ...
    <meta name="description"
          content="Jewel Kilcher site featuring a Biography, Lyrics, Downloads, and information about Jewel and her life.">
...
<body
    onload="MM_preloadImages('../images/pale_01.gif','../images/pale_02.gif', '../images/pale_03.gif', '../images/pale_04.gif', '../images/pale_05.gif' )">
    ...
    <tr>
        <td>
            <a href="index.php" onmouseout="MM_swapImgRestore()"
               onmouseover="MM_swapImage('Menu1','','../images/pale_01.gif',1)"><img src="../images/menu_01.gif"
                                                                                     alt="Home" name="Image6" width="85"
                                                                                     height="35" id="Menu1"/></a></td>
        <td>
            <a href="bio/index.html" onmouseout="MM_swapImgRestore()"
               onmouseover="MM_swapImage('Menu2','','../images/pale_02.gif',1)"><img src="../images/menu_02.gif"
                                                                                     alt="Biography" width="115"
                                                                                     height="35" id="Menu2"/></a></td>
        <td>
            <a href="disc/index.html" onmouseout="MM_swapImgRestore()"
               onmouseover="MM_swapImage('Menu3','','../images/pale_03.gif',1)"><img src="../images/menu_03.gif"
                                                                                     alt="Discography" width="136"
                                                                                     height="35" id="Menu3"/></a></td>
        <td>
            <a href="news/index.php"
               onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Menu4','','../images/pale_04.gif',1)"><img
                    src="../images/menu_04.gif" alt="News" width="88" height="35" id="Menu4"/></a></td>
        <td>
            <a href="pics/index.html" onmouseout="MM_swapImgRestore()"
               onmouseover="MM_swapImage('Menu5','','../images/pale_05.gif',1)"><img src="../images/menu_05.gif"
                                                                                     alt="Pictures" width="100"
                                                                                     height="35" id="Menu5"/></a></td>
    </tr>
</table>
<!-- End Navigation Menu -->
...
<div id="content">
    ...
    <ul style="list-style-type: circle;" onmouseover="this.style.color = 'blue';"
    ...
    <p>
        <span style="float: left; width: 150px;"><a href="news/index" title="More News"
                                                    style="font: 1.3em Arial, Helvetica, sans-serif; margin-left: .2in; color: black; text-decoration: none;">more
                news &gt;</a></span>

        <span style=""><img src="../images/feed.gif" alt="RSS News Feed"/> <a href="news/feed.php">Subscribe</a></span>
    </p>
        ...
        <form method="post" id="navmenu" action="" onsubmit="navigate(document.getElementById('url')); return false">
            <fieldset>
                ...
                <select name="url" id="url" size="1">
                    ...
                    <option value="http://www.foolishgames.com/jewel/books/revealing_jewel/index.html">Revealing Jewel
                    </option>
                </select>
    ...
    <p style="text-indent: .3in; text-align: Justify; line-height: 1.5;"><span style="font-size: 1.5em;">J</span>ewel
        Kilcher is a bright and rising artist who hit the scene back in 1995 with her debut release
        Pieces of You. Since then she has proven her exceptional ability and has gained respect among the
        music community. To learn more about this amazing artist, please read the <a href="bio/index.html"
                                                                                     title="Jewel Biography by Lucas Holt">Biography.</a>
    </p>
